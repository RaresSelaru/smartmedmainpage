...
export function HeroMediaFrame() {
  return (
    <>
      <div className="hero-media-field pointer-events-none absolute inset-0 overflow-hidden">
        <div className="hero-media-image-mask">
          <Image
            ...
            fill
            loading="eager"
            sizes="(max-width: 767px) 140vw, (max-width: 1023px) 96vw, 1600px"
      ...
      <button
        ...
        className="hero-media-play pointer-events-auto absolute right-8 z-[15] flex size-14 -translate-y-1/2 items-center justify-center rounded-full border border-white/16 bg-white/10 text-smart-white shadow-[0_0_64px_16px_rgba(156,206,208,0.20),0_18px_50px_rgba(3,17,28,0.38)] backdrop-blur-xl transition hover:scale-[1.04] hover:bg-white/18 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-smart-aqua sm:size-16 md:size-16 lg:size-20"
        type="button"
      >

...
export function FinalCTASection() {
  return (
    <section className="relative isolate overflow-hidden bg-smart-cream px-5 py-20 text-smart-ink sm:px-7 lg:px-8 lg:py-18">
      <div
        aria-hidden="true"
      ...
      />
      <div className="relative z-10 mx-auto grid max-w-7xl items-center gap-10 lg:grid-cols-[0.9fr_0.8fr_0.9fr] lg:gap-9">
        <Reveal>
          <div className="mx-auto max-w-md text-center">
            <blockquote className="font-serif text-2xl italic leading-9 text-smart-ink/82 sm:text-3xl lg:text-[27px]">
              &ldquo;Succesul nu vine din ceea ce faci din când în când, ci din ceea ce
              faci în mod constant.&rdquo;
            </blockquote>
            <p className="mt-6 font-serif text-3xl italic text-smart-teal lg:text-[28px]">
              SmartMed Academy
            </p>
          </div>
        </Reveal>
        <Reveal delay={0.08}>
          <div className="relative mx-auto w-full max-w-md lg:max-w-[380px]">
            <Image
              ...
              height={1235}
              sizes="(max-width: 1024px) 82vw, 380px"
        ...
        <Reveal delay={0.16}>
          <div className="text-left lg:text-center">
            ...
            <h2 className="mt-3 font-serif text-5xl font-semibold leading-none tracking-[-0.025em] sm:text-6xl lg:text-[54px]">

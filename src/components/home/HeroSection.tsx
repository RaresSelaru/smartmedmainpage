    ...
    >
      ...
      <div className="relative z-10 mx-auto flex max-w-[1580px] items-center py-8 sm:py-10 lg:min-h-[460px] lg:max-w-[var(--smart-wide-content-max)] lg:py-8">
        <div className="flex w-full min-w-0 max-w-[320px] flex-col items-start text-left sm:max-w-[620px] lg:max-w-[740px]">
          <Reveal>
            <div>
              <h1 className="inline-block text-center font-serif text-[36px] font-semibold leading-[1.04] tracking-normal text-smart-white drop-shadow-[0_12px_34px_rgba(0,0,0,0.34)] sm:text-[50px] lg:text-[58px]">
                {heroCopy.titleLead}
                <span className="mt-2 block whitespace-nowrap bg-[linear-gradient(180deg,#f2d99f_0%,#d5ad6b_48%,#b88643_100%)] bg-clip-text text-[60px] font-bold leading-[0.86] text-transparent drop-shadow-[0_8px_22px_rgba(0,0,0,0.26)] sm:mt-3 sm:text-[86px] lg:text-[116px]">
                  {heroCopy.titleHighlight}
                </span>
              </h1>
              <div
                aria-hidden="true"
                className="relative mt-2 h-px w-full max-w-[620px] bg-gradient-to-r from-transparent via-smart-gold-light/70 to-transparent sm:mt-3 lg:max-w-[630px]"
              >
          ...
          <Reveal delay={0.08}>
            <p className="mt-7 max-w-[720px] font-serif text-[22px] font-medium leading-[1.36] text-smart-white/92 drop-shadow-[0_10px_28px_rgba(0,0,0,0.34)] sm:text-[26px] lg:mt-6 lg:text-[26px]">
          ...
          <Reveal delay={0.14}>
            <div className="mt-8 flex w-full flex-col gap-4 sm:flex-row sm:items-center sm:gap-6 lg:mt-7 lg:gap-5">
              <Link
                className="group inline-flex min-h-[60px] items-center justify-center gap-4 rounded-xl border border-smart-gold-light/50 bg-[linear-gradient(180deg,#efd298_0%,#d4aa68_100%)] px-7 py-4 text-base font-extrabold text-smart-abyss shadow-[0_18px_42px_rgba(213,173,107,0.22),inset_0_1px_0_rgba(255,255,255,0.52)] transition duration-300 hover:-translate-y-0.5 hover:shadow-[0_22px_52px_rgba(213,173,107,0.30),inset_0_1px_0_rgba(255,255,255,0.62)] focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-4 focus-visible:outline-smart-gold sm:min-w-[360px] sm:text-lg lg:min-w-[330px]"
          ...
          <Reveal delay={0.26}>
            <div className="mt-9 lg:mt-8">
              <Image
                ...
                className="h-auto w-[min(760px,88vw)] object-contain object-left drop-shadow-[0_8px_22px_rgba(0,0,0,0.28)] lg:w-[min(684px,78vw)]"
                height={360}

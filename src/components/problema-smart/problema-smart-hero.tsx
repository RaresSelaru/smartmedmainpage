...
export function ProblemaSmartHero() {
  return (
        ...
        <Reveal className="w-full min-w-0">
          <div className="w-full min-w-0 max-w-[700px]">
            <h1 className="font-serif text-[42px] font-semibold leading-[0.98] tracking-normal text-smart-white drop-shadow-[0_14px_36px_rgba(0,0,0,0.36)] sm:text-[56px] lg:text-[70px] xl:text-[82px] 2xl:text-[90px]">
              ...
              <span className="mt-2 block bg-[linear-gradient(180deg,#f7dfaa_0%,#d7b06e_52%,#b98643_100%)] bg-clip-text text-[46px] font-bold leading-[0.9] text-transparent drop-shadow-[0_10px_28px_rgba(0,0,0,0.26)] sm:text-[74px] lg:text-[90px] xl:text-[98px] 2xl:text-[106px]">
                <span className="inline-block">
                  <span className="block">PROBLEMA</span>

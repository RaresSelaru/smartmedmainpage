...
export function EvaluationHero() {
  return (
    <section className="relative isolate min-h-[720px] overflow-hidden bg-smart-dark px-5 pb-44 pt-32 text-smart-white sm:px-7 sm:pb-48 sm:pt-36 lg:px-8">
      ...
      <div className="relative z-10 mx-auto grid max-w-7xl gap-12 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        <Reveal>
          ...
          <h1 className="mt-5 max-w-[760px] font-serif text-[3.55rem] font-semibold leading-[0.9] tracking-[-0.045em] sm:text-7xl lg:text-[6.25rem]">
            Începem cu tine,
        ...
        <Reveal className="lg:pl-6">
          <div className="relative min-h-[410px] overflow-hidden rounded-[2.75rem] border border-white/14 bg-smart-teal shadow-[0_34px_100px_rgba(0,0,0,0.42)] sm:min-h-[520px]">
            <Image
            ...
            <div className="absolute inset-x-5 bottom-5 rounded-[1.65rem] border border-white/14 bg-smart-abyss/78 p-5 backdrop-blur-xl sm:inset-x-7 sm:bottom-7 sm:p-6">
              ...
              <ul className="mt-5 grid gap-2.5 border-t border-white/10 pt-4 text-xs font-semibold text-smart-white/68 sm:grid-cols-3">

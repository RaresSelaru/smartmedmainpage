...
export function PageShell({ page, children, variant = "standard" }: PageShellProps) {
  return (
    <>
      <section className="relative isolate min-h-[620px] overflow-hidden bg-smart-dark px-5 pb-44 pt-32 text-smart-white sm:px-7 lg:min-h-[36rem] lg:px-8 lg:pb-[var(--smart-desktop-hero-bottom)] lg:pt-[var(--smart-desktop-hero-top)]">
        ...
        <div className="relative z-10 mx-auto grid max-w-[var(--smart-content-max)] gap-10 lg:grid-cols-[0.95fr_1.05fr] lg:items-end lg:gap-9">
          <Reveal>
            <SectionLabel>{page.eyebrow}</SectionLabel>
            <h1 className="mt-5 max-w-4xl font-serif text-5xl font-semibold leading-[0.96] tracking-[-0.03em] sm:text-7xl lg:text-[5.5rem]">
              {page.title}
            </h1>
          </Reveal>
          <Reveal delay={0.08}>
        ...
        <>
          ...
          <section className="relative overflow-hidden bg-smart-teal px-5 pb-44 pt-24 text-smart-white sm:px-7 lg:px-8 lg:pb-[var(--smart-desktop-wave-space)] lg:pt-[var(--smart-desktop-section-space)]">
            ...
            <div className="relative z-10 mx-auto grid max-w-[var(--smart-content-max)] gap-10 lg:grid-cols-[0.8fr_1.2fr] lg:gap-9">
              ...
              <Reveal delay={0.08}>
                <GlassCard className="p-7 lg:p-[1.625rem]">
                  <div className="flex items-center gap-3">
                    ...
                    <div>
                      <h3 className="font-serif text-3xl font-semibold lg:text-[1.75rem]">
          ...
          <section className="bg-smart-cream px-5 py-20 text-smart-ink sm:px-7 lg:px-8 lg:py-[4.5rem]">
            <Reveal>

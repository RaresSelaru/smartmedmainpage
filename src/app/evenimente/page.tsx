...
export const metadata: Metadata = {
  ...
  openGraph: {
    title: "Evenimente SmartMed | " + siteConfig.name,
    description,
  ...
  return (
    <>
      <section className="relative isolate overflow-hidden bg-smart-dark px-5 pb-44 pt-32 text-smart-white sm:px-7 sm:pt-36 lg:px-8">
        ...
        <div className="relative z-10 mx-auto grid max-w-[var(--smart-content-max)] gap-12 lg:grid-cols-[0.9fr_1.1fr] lg:items-center">
          <Reveal>
                ...
                <div>
                  ...
                  <p className="mt-1 text-sm font-semibold text-smart-white/82">
                    {openEvents.length === 1
                      ...
                      : String(openEvents.length) +
                        " experiențe cu înscrieri deschise"}
                  </p>
                </div>
              </div>
            </div>

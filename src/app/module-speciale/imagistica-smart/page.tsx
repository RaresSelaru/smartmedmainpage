...
import { ImagisticaSmartHero } from "@/components/imagistica-smart/imagistica-smart-hero";
import { WaveSeparator } from "@/components/ui/WaveSeparator";
import { newsCarousel } from "@/lib/site-config";

export const metadata: Metadata = {
  title: "Imagistica SMART | SmartMed Academy",
  description: "Placeholder — descriere pagină Imagistica SMART.",
};

export default function ImagisticaSmartPage() {
  return (
    <>
      <ImagisticaSmartHero />

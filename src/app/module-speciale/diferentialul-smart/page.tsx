...
import { DiferentialulSmartHero } from "@/components/diferentialul-smart/diferentialul-smart-hero";
import { WaveSeparator } from "@/components/ui/WaveSeparator";
import { newsCarousel } from "@/lib/site-config";

export const metadata: Metadata = {
  title: "Diferențialul SMART | SmartMed Academy",
  description: "Placeholder — descriere pagină Diferențialul SMART.",
};

export default function DiferentialulSmartPage() {
  return (
    <>
      <DiferentialulSmartHero />

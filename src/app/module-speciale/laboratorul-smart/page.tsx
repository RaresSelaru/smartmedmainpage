...
import { LaboratorulSmartHero } from "@/components/laboratorul-smart/laboratorul-smart-hero";
import { WaveSeparator } from "@/components/ui/WaveSeparator";
import { newsCarousel } from "@/lib/site-config";

export const metadata: Metadata = {
  title: "Laboratorul SMART | SmartMed Academy",
  description: "Placeholder — descriere pagină Laboratorul SMART.",
};

export default function LaboratorulSmartPage() {
  return (
    <>
      <LaboratorulSmartHero />

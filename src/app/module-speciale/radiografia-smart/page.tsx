...
import { RadiografiaSmartHero } from "@/components/radiografia-smart/radiografia-smart-hero";
import { WaveSeparator } from "@/components/ui/WaveSeparator";
import { newsCarousel } from "@/lib/site-config";

export const metadata: Metadata = {
  title: "Radiografia SMART | SmartMed Academy",
  description: "Placeholder — descriere pagină Radiografia SMART.",
};

export default function RadiografiaSmartPage() {
  return (
    <>
      <RadiografiaSmartHero />
